...
app.get('/test/route/:param1/:param2',blogcontroller.routeParam);
app.get('/test/query',blogcontroller.queryParam);
app.post('/test/body',blogcontroller.bodyParam);
...
app.post(baseUrl+'/createBlog',auth.isAuthenticated,blogcontroller.createBlog);
...
app.put(baseUrl+'/editBlog/:blogId',auth.isAuthenticated,blogcontroller.editBlog);
...
app.post(baseUrl+'/deleteBlog/:blogId',auth.isAuthenticated,blogcontroller.deleteBlog);
